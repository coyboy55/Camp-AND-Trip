...
import ReservationControle from '../screens/reserationControle';
...
export default function OnboardingStack(props) {
  ...
  return (
    <Stack.Navigator mode="card" headerMode="none">
      {token ? <Stack.Screen name='App' component={AppStack}/> :  <Stack.Screen name="login" component={Login} />}
      <Stack.Screen
        name="Onboarding"
      ...
      <Stack.Screen name="logiin" component={Login} />
